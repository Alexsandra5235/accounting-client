...
return [
    ...
    | каждое из этих сообщений здесь в соответствии с потребностями.
    |
    */
    ...
    'max'                  => [
        ...
        'string'  => 'Длина строки в поле :attribute не должна быть больше :max символов.',
    ],
    ...
    'prohibited_unless'    => 'Поле :attribute запрещено, если только :other не в списке :values.',
    ...
    'required_with_all'    => 'Поле :attribute обязательно для заполнения, когда все :values присутствуют.',
    ...
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать собственные сообщения для конкретных полей,
    | используя синтаксис "attribute.rule".
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Пользовательские атрибуты (имена полей)
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете задать "человеческие" названия полей, которые заменят
    | плейсхолдер:attribute в сообщениях об ошибках.
    |
    */

    'attributes' => [
        'date_receipt' => '"Дата поступления"',
        'time_receipt' => '"Время поступления"',
        'name' => '"ФИО"',
        'birth_day' => '"Дата рождения"',
        'gender' => '"Пол"',
        'medical_card' => '"Номер мед.карты"'
    ],
