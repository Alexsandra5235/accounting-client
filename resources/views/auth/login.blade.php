...
<head>
    ...
    <title>Авторизация | Система учета пациентов санатория «Журавлик»</title>
...
<div class="main-container">
    <div class="login-card">
        <div class="card-header">
            <h1>Авторизация</h1>
            <h3>Вход в систему учета пациентов</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <!-- Session Status -->
            @if (session('status'))
                <div class="mb-4 text-sm text-green-600" style="color: #10b981; text-align: center; padding: 0.5rem; background: #f0fdf4; border-radius: var(--radius);">
                    {{ session('status') }}
                </div>
            @endif
                ...
                <div class="mt-4">
                    <label for="remember_me" class="checkbox-label">
                        ...
                        <span class="checkbox-text">
                            <i class="fas fa-save" style="margin-right: 0.3rem;"></i>
                            Запомнить меня
                        </span>
                    </label>
                </div>
            ...
            <div class="info-box">
                ...
                <p>
                    Регистрация только через администратора. Обратитесь к заведующей для получения доступа.
                </p>
            </div>
        </div>
    </div>
