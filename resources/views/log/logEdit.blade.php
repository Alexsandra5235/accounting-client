                        ...
                        <section>
                            ...
                            <div class="mt-6 space-y-6">
                                <div>
                                    ...
                                    <x-text-input id="date_receipt" name="date_receipt" type="text" class="mt-1 block w-full" :value="$log->log_receipt->date_receipt"/>
                                    <x-input-error class="mt-2" :messages="$errors->get('date_receipt')" />
                                </div>

                                <div>
                                    <x-input-label for="time_receipt" :value="__('Время поступления')" />
                                    <x-text-input id="time_receipt" name="time_receipt" type="text" class="mt-1 block w-full" :value="$log->log_receipt->time_receipt"/>
