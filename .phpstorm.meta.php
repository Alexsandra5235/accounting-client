...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\ProjectPhp\praktika\project\public\storage' => 'string',
...
'cache.prefix','charts.default_library','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\ProjectPhp\\praktika\\project\\public\\storage','ide-helper.filename',
...
'platform.domain','platform.prefix','platform.middleware.public','platform.middleware.private','platform.guard',
'platform.auth','platform.index','platform.profile','platform.resource.stylesheets','platform.resource.scripts',
'platform.vite','platform.template.header','platform.template.footer','platform.attachment.disk','platform.attachment.generator',
'platform.icons.bs','platform.notifications.enabled','platform.notifications.interval','platform.search','platform.turbo.cache',
'platform.turbo.prefetch','platform.turbo.refresh-method','platform.turbo.refresh-scroll','platform.fallback','platform.workspace',
...
'hashing.rehash_on_login','view.paths','view.compiled','scout.driver','scout.prefix',
...
'scout.typesense.model-settings','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'dashboard','profile.edit','profile.update',
'profile.destroy','log.store','log.destroy','log.edit','log.update',
'log.find','log.add','log.search','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','platform.index','platform.search',
'platform.async','platform.async.listener','platform.systems.files.upload','platform.systems.files.media','platform.systems.files.sort',
'platform.systems.files.destroy','platform.systems.files.update','platform.systems.relation','platform.systems.sorting','platform.notifications',
'platform.api.notifications','platform.','platform.login','platform.login.auth','platform.login.lock',
'platform.','platform.switch.logout','platform.logout','platform.main','platform.logout',
...
'platform.systems.roles.create','platform.systems.roles','platform.example','platform.patient.flow','platform.predict',
'platform.example.fields','platform.example.advanced','platform.example.editors','platform.example.actions','platform.example.layouts',
'platform.example.grid','platform.example.charts','platform.example.cards','storage.local',);
...
'layouts.app','layouts.guest','layouts.navigation','log.logAdd','log.logEdit',
'log.logShow','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','API_LOG_ALL_URL',
'API_LOG_URL','API_LOG_SEARCH_URL','API_LOG_GROUPING','API_LOG_TOKEN','TELEGRAM_TOKEN',
'TELEGRAM_CHAT_ID','SCOUT_DRIVER',);
